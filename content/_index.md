...
The training process is *guided* by a loss function that incorporates symbolic knowledge, i.e., it **penalizes** the model when it makes predictions that **violates** the knowledge.
...
#### Data
{{< image height="30" src="/iris-dataset.png" >}}
